...
The generic program is `souffle_static_analysis/dataclass_deduction_model.dl`.
...
- Semantic flow and boundary-test derivations are handled in `souffle_static_analysis/semantic_model.dl`, not this deduction-only layer.
